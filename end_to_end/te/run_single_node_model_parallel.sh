...
OTHER_ARGS="--additional-args=\"\"\"fused_mlp=true ${PROFILE_ARG}\"\"\""
TRAINING_RECIPES=("fp8" "te_fp8_delayedscaling" "te_fp8_currentscaling" "te_mxfp8" "te_noscaling")   # fp8 is the MaxText baseline
